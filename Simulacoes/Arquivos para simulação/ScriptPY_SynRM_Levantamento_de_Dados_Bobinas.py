...
#Função para iterar sobre uma coluna, encontrar um valor específico 
#e retornar uma dado de outra coluna na mesma linha
...
cabecalho = ["Posicao","Fluxo_Concatenado_estatorA","Fluxo_Concatenado_estatorB",
             "Fluxo_Concatenado_estatorC","Tensao_A","Tensao_B","Tensao_C",
             "Indutancia_A","Indutancia_B","Indutancia_C","R_A","R_B","R_C",
...
for angulo in range(0,366-delta_angulo,delta_angulo):
    ...
    #Grava os resultados de interesse na lista resultado. Se qualquer das correntes for zero o programa irá dar erro
    #Personalize a lista resultado abaixo de acordo
    resultado = [angulo,Fluxo_Concatenado_estatorA,Fluxo_Concatenado_estatorB,
                 Fluxo_Concatenado_estatorC,Tensao_estatorA,Tensao_estatorB,
                 Tensao_estatorC,Fluxo_Concatenado_estatorA/Corrente_estatorA,
                 Fluxo_Concatenado_estatorB/Corrente_estatorB,
                 Fluxo_Concatenado_estatorC/Corrente_estatorC,
                 Tensao_estatorA/Corrente_estatorA,
                 Tensao_estatorB/Corrente_estatorB,
                 Tensao_estatorC/Corrente_estatorC,
                 Tensao_estatorA*Corrente_estatorA,
                 Tensao_estatorB*Corrente_estatorB,
                 Tensao_estatorC*Corrente_estatorC]
